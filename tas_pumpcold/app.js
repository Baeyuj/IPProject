...
function fetchCinFromMobius() {
    const options = {
        ...
        port: 7579,
        path: '/Mobius/IoTPTeam2/pumpcold/la',  // 'la'는 latest content instance
        method: 'GET',
        headers: {
            'X-M2M-RI': '12345',
...
const COLD_ON_PIN = new Gpio(17, 'out'); //A-1A : 17, A-1B : 27
const COLD_OFF_PIN = new Gpio(27, 'out'); //A-1A : 17, A-1B : 27
